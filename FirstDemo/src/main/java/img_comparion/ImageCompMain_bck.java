...
public class ImageCompMain_bck {
	public static void main(String[] args) throws IOException {		
		...
		compareWithBaseImage(new File(baseFile), new File(changeFile), baseFile.substring(baseFile.lastIndexOf('\\'), baseFile.lastIndexOf('.'))); 
	}
	public static void createPngImage(BufferedImage image, String fileName) throws IOException {
		ImageIO.write(image, "png", new File("C:\\Users\\Vikash\\Pictures\\Screenshots\\Comparison\\"+fileName));
	}
	public static void createJpgImage(BufferedImage image, String fileName) throws IOException {
		ImageIO.write(image, "jpg", new File("C:\\Users\\Vikash\\Pictures\\Screenshots\\Comparison\\"+fileName));
	}
